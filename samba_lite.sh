...
#	Instalar winbind:
	apt -y -q install winbind &>> $LOG
	echo -e "[ \033[0;32m OK \033[0m ] Winbind ..."
	sleep 1

#	Instalar dnsutils:
	apt -y -q install dnsutils &>> $LOG
	echo -e "[ \033[0;32m OK \033[0m ] Utilitarios DNS ..."
	sleep 1
...
#	Instalar SAMBA4:
	apt -y -q install samba smbclient &>> $LOG
...
#	Configurar SAMBA4:
	...
	samba-tool user create $USUARIO P@ssword --rfc2307-from-nss #--login-shell=/bin/sh --uid-number="10000" --gid-number="10000" --nis-domain --unix-home=/home/$USUARIO
