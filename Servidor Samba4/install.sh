...
bash ver.sh		# verifica permições
bash rede.sh		# configura a rede 
bash prep.sh		# atualiza e prepara repositorios
bash base.sh		# instala e configura programas basicos
bash ntp.sh		# instala e configura o NTP
bash addc.sh		# instala e configura o KERBERUS
